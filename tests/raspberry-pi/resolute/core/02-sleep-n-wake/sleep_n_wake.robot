...
Assert Test init
    ...
    Match    ${CURDIR}/snapshots/screens/dark_circle_of_friends.jpg

Sleep
    [Documentation]    Sleep from the desktop environment
    Keys Combo    Meta_L    l
    Match    ${CURDIR}/snapshots/screens/no_signal.jpg
...
Desktop
    ...
    Sleep    1
    Keys Combo    Return
    Match    ${CURDIR}/snapshots/screens/dark_circle_of_friends.jpg    15
