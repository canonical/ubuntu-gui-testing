...
Click Reboot Button
    ...
    Match    ${CURDIR}/snapshots/screens/screen_02.jpg    200
...
Login
    ...
    Sleep    1
    Keys Combo    Return
    Match    ${CURDIR}/snapshots/templates/dark_circle_of_friends.jpg    20
